...
public class Add implements Command {
    ...
    protected static void addName() {
        try {
            ...
            String name = ClientMain.reader.readLine() ;
    ...
    protected static void addCoordinates() {
        try {
            ...
            String s = ClientMain.reader.readLine() ;
            if (s.equals("") | s == null) {
    ...
    protected static void addFrom() {
        try {
            ...
            String locationFromName = ClientMain.reader.readLine();
    ...
    protected static void addTo() {
        try {
            ...
            String locationToName = ClientMain.reader.readLine();
